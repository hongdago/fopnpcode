...
def get_block(sock):
    data = receall(sock, header_struct.size)
    (block_length,)  = header_struct.unpack(data)
    return receall(sock, block_length)
...
def client(address):
    ...
    put_block(sock, b'Simple is better than comple.\n')
    put_block(sock, b'')
    sock.close()
