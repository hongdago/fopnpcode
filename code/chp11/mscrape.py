...
def download_page_with_requests(base):
    ...
    response = session.post(urljoin(base, '/login'), {'username':'brandon', 'password':'atigdng'})
...
def main():
    parser = argparse.ArgumentParser(description='Scrap our payments site.')
    parser.add_argument('url', help='the URL at which to begin')
    parser.add_argument('-l', action='store_true', help='Scrap using lxml')
